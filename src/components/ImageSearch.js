        ...
        <div className='max-w-sm rounded overflow-hidden my-10 mx-auto'>
            <form onSubmit={onSubmit} className='w-full max-w-sm'>
                <div className='flex items-center border-b-2 border-blue-700 py-2'>
                    ...
                    focus:outline-none' type="text" placeholder='Search Image Term...' />
                    <button className='flex-shrink-0 bg-blue-700 hover:bg-blue-900 border-blue-700 hover:border-blue-900
